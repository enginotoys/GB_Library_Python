...
async def payload_gen():
    ...
    array_struct_gen.append(hex(ord('0'))), array_struct_gen.append(hex(ord('0'))), array_struct_gen.append(
        hex(ord('8')))
...
async def payload_empty():
    ...
    array_struct_empty.append(hex(ord('0'))), array_struct_empty.append(hex(ord('0'))), array_struct_empty.append(
        hex(ord('8')))
...
async def controller():
    ...
    while run:
        ...
        for event in pygame.event.get():
            ...
            if not state[pygame.K_LEFT] and not state[pygame.K_RIGHT] and not state[pygame.K_UP] and not state[
                pygame.K_DOWN]:
